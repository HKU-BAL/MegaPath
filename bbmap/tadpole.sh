...
deadzone=0          (dz) Do not try to correct bases within this distance of
                    read ends.
window=10           Length of window to use in reassemble error-correct mode.
windowlimit=2       If more than this many errors are detected within a
                    a window, halt correction on that read.
